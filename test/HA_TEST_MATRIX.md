...
- Log isolation coverage keeps Jellyfin stdout/stderr out of Remora's structured records, tails the dedicated managed console file by source, preserves ANSI bytes, follows appends and active-file rotation, and verifies lumberjack backup naming.
